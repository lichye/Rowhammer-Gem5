...
39:                                               ; preds = %35, %63
  ...
  %46 = load float, float addrspace(1)* %36, align 4, !tbaa !11
  %47 = fdiv contract float %46, %38
  %48 = bitcast float addrspace(1)* %45 to i32 addrspace(1)*
  %49 = load atomic i32, i32 addrspace(1)* %48 monotonic, align 4
  br label %50

50:                                               ; preds = %61, %39
  %51 = phi i32 [ %49, %39 ], [ %62, %61 ]
  %52 = load atomic i32, i32 addrspace(1)* %48 monotonic, align 4
...
54:                                               ; preds = %50
  ...
  %58 = cmpxchg i32 addrspace(1)* %48, i32 %51, i32 %57 monotonic monotonic
  %59 = extractvalue { i32, i1 } %58, 0
  %60 = extractvalue { i32, i1 } %58, 1
  br i1 %60, label %63, label %61

61:                                               ; preds = %54, %50
  %62 = phi i32 [ %59, %54 ], [ %52, %50 ]
  br label %50
