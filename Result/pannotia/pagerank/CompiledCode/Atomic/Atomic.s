...
BB0_5:                                  ; =>This Loop Header: Depth=1
	...
	s_mov_b64 s[8:9], 0
	s_waitcnt vmcnt(0) lgkmcnt(0)
	v_div_scale_f32 v9, s[0:1], v3, v3, v8
	v_add_u32_e64 v6, s[0:1], s2, v6
	v_addc_u32_e64 v7, s[0:1], v11, v7, s[0:1]
	flat_load_dword v6, v[6:7]
	v_div_scale_f32 v10, vcc, v8, v3, v8
	s_mov_b64 s[0:1], 0
	v_rcp_f32_e32 v1, v9
	v_fma_f32 v11, -v9, v1, 1.0
	v_fma_f32 v1, v11, v1, v1
	v_mul_f32_e32 v11, v10, v1
	v_fma_f32 v12, -v9, v11, v10
	v_fma_f32 v11, v12, v1, v11
	v_fma_f32 v9, -v9, v11, v10
	v_div_fmas_f32 v1, v9, v1, v11
	v_mov_b32_e32 v9, s7
...
; %bb.7:                                ;   in Loop: Header=BB0_6 Depth=2
	...
	flat_atomic_cmpswap v8, v[6:7], v[8:9] glc
	s_mov_b64 s[8:9], 0
	s_waitcnt vmcnt(0) lgkmcnt(0)
